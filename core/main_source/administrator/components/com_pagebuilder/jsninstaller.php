...
<script type="text/javascript">
    ...
    {
        $shortcodeFilePath 	= $this->parentInstaller->getPath('source') . '/admin/helpers/shortcode.php';
        $defineFilePath 	= $this->parentInstaller->getPath('source') . '/admin/defines.pagebuilder.php';

        if (is_file($shortcodeFilePath) && is_file($defineFilePath))
        {

            include_once $defineFilePath;
            if(!class_exists(JSNPagebuilderHelpersShortcode)) {
            ...
            $additionalShortCodes 	= $objJSNPagebuilderHelpersShortcode::getAdditionalShortCodePlugins();

            // Get default shortcodes
            $defaultShortCodes 		= $objJSNPagebuilderHelpersShortcode::getDefaultShortcodePlugins();
            ...
            $objJSNPagebuilderHelpersShortcode::setShortCodePluginsToCache($shortcodes);
