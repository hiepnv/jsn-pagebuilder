...
<div class="jsn-master" id="pb-custom-css-box">
    <div class="jsn-bootstrap3">
        ...
        <div
            ...
            <label for="option-items-itemlist" class="control-label top-cut"><?php echo JText::_( 'CSS Files' ); ?><i
        ...
        <div class="control-group jsn-items-list-container modal-content">
            <label for="option-items-itemlist" class="control-label"><?php echo JText::_( 'CSS Code' ); ?><i
                    class="icon-question-sign tooltip-toggle" data-html="true"
                    data-original-title="<?php JText::_( 'Input here custom CSS code you want to be loaded on this page' ); ?>"></i>
            </label>
