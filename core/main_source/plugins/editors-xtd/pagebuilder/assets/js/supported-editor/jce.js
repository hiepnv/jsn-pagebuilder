        ...
        JSNPbEditorHelper.initEntryButtons	= function (source_id, pbEntryButtons){
            ...
            $('.switchmode-button.pb-off', buttonGroups).on('click',  function (){
                if (!$(this).hasClass('active')) {
                    ...
                    $('#' + source_id +', jform_articletext, #editor-xtd-buttons', container).addClass('editor-hidden').hide();
                    $('#' + source_id +', jform_content, #editor-xtd-buttons', container).addClass('editor-hidden').hide();
                }
            });
            return buttonGroups;
        },
