...
(function ($) {
    ...
    $.GoogleMapElement = function (iframe) {
        ...
        var select_destination = $(iframe.contentDocument.getElementById('select_param-gmi_destination'));
        var exclude_title = $(iframe.contentDocument.getElementById('param-gmi_title')).val();
        var currentValue = $(iframe.contentDocument.getElementById('param-gmi_destination')).val();
        ...
        $(iframe.contentDocument.getElementById('select_param-gmi_destination')).on('change', function () {
