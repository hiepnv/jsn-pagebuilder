...
class JSNPBShortcodeGooglemap extends IG_Pb_Element
{
	...
	public function backend_element_assets()
	{
		...
		$document->addScript(JSNPB_ELEMENT_URL . '/googlemap/assets/js/googlemap.js', 'text/javascript');
	...
	public function element_config()
	{
		...
		$this->config['name']             = JText::_('Google Maps');
		$this->config['cat']              = JText::_('Extra');
		$this->config['icon']             = 'icon-google-map';
		$this->config['description']      = JText::_("Map with a specified title and location");
		$this->config['has_subshortcode'] = __CLASS__ . 'Item';
		$this->config['exception']        = array(
			'default_content'             => JText::_('Google Maps'),
			'data-modal-title'            => JText::_('Google Maps'),
		);
	}
		...
		$this->items = array(
			'content' => array(
				array(
					...
					'std'     => JText::_('Google Map PB_INDEX_TRICK'),
					'role'    => 'title',
			...
			'styling' => array(
				...
				array(
					...
					'tooltip' => JText::_('Container Style'),
				),
				array(
				...
				array(
					...
					'gmap_dimension_height'     => array('std' => '500'),
				...
				array(
					...
					'tooltip'            => JText::_('Margin'),
				),
				array(
					'type' => 'hr',
				),
				array(
					'name'    => JText::_('Zoom Level'),
					'id'      => 'gmap_zoom',
					'class'   => 'pb-slider',
					'type'    => 'slider',
					'std_max' => '18',
				...
				array(
					...
					'options'         => array(
						'streetViewControl' => JText::_('Street View'),
						'zoomControl'       => JText::_('Zoom Control'),
						'panControl'        => JText::_('Pan Control'),
						'mapTypeControl'    => JText::_('Map Type Control'),
						'scaleControl'      => JText::_('Scale Control'),
						'overviewControl'   => JText::_('Overview Control'),
