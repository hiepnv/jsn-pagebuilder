...
//		$document->addStyleSheet(JSNPB_ELEMENT_URL . '/testimonial/assets/css/testimonial.css', 'text/css');
	...
	public function element_config()
	{
		...
		$this->config['name']             = JText::_('Testimonial');
		$this->config['cat']              = JText::_('Extra');
		$this->config['icon']             = 'icon-testimonial';
		$this->config['description']      = JText::_("Testimonial with flexible settings");
		...
		$this->items = array(
			'content' => array(
				array(
					...
					'std'     => JText::_('Testimonial PB_INDEX_TRICK'),
					'role'    => 'title',
					'tooltip' => JText::_('Set title for current element'),
				),
				array(
					'name'          => JText::_('Testimonial Items'),
			...
			'styling' => array(
				...
				array(
					...
					'options'         => array(
						'arrows'    => JText::_('Arrows'),
						'indicator' => JText::_('Indicator'),
					),
				),
				array(
					'name'            => JText::_('Content Elements'),
					'id'              => 'content_elements',
					'type'            => 'items_list',
					'std'             => 'content__#__image__#__name__#__job_title__#__country__#__company',
					'options'         => array(
						'content'   => JText::_('Feedback Content'),
						'image'     => JText::_('Avatar'),
						'name'      => JText::_('Client\'s Name'),
						'job_title' => JText::_('Client\'s Position'),
						'country'   => JText::_('Country'),
						'company'   => JText::_('Company'),
					),
				...
				array(
					'name'              => JText::_('Length Limitation'),
					'id'                => 'content_length',
					'type'              => array(
						array(
							'id'           => 'content_count',
